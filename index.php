...
if(!empty($_POST["send"])) {
	...
	$result = mysqli_query($connexion, "INSERT INTO contact (name, prenom, tel, email, subject, message) VALUES ('" . $name. "','" . $prenom. "','" . $tel. "', '" . $email. "','" . $subject. "','" . $message. "')");
	if($result){
	...
	<body>
		<div id="box">
		  <form id="form" enctype="multipart/form-data" onsubmit="return validate()" method="post">
		    ...
		    <input type="number" id="tel" name="tel" placeholder="tel"/>
